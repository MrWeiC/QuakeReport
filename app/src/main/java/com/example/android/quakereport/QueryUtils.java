...
public final class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String stringUrl){
        ...
        try {
            ...
            Log.v("EarthQuakeActivity", "Successfully make Http Request");
        } catch (IOException e) {
            Log.v("EarthQuakeActivity", "Failed make Http Request");

        }
        List<Earthquake> earthquakes = extractEarthquakes(jsonResponse);
        Log.v("EarthQuakeActivity", "Successfully extract EarthQuake ArrayList");
        return earthquakes;
    }
}